...
if($_POST){
    ...
    if(isset($_POST['enviar'])){
        $nome_img   =   $_FILES['imagem_tipos']['name'];
        $tmp_img    =   $_FILES['imagem_tipos']['tmp_name'];
                ...
                <div class="alert alert-danger" role="alert">
                    <form action="tipos_insere.php" id="form_tipos_insere" name="form_tipos_insere" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="sigla_tipo" id="sigla_tipo" class="form-control" placeholder="Digite o tipo." maxlength="15" required>
                        </div><!-- fecha input-group -->
                        <br>
